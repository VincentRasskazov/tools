...
const tools = [
  ...
  { name: "Leet Speak Converter", path: "/tools/leet-speak-converter" },
    ...
    { name: "Palindrome Checker", path: "/tools/batch3/palindrome-checker" },
    { name: "Anagram Solver", path: "/tools/batch3/anagram-solver" },
    { name: "Text Reverser", path: "/tools/batch3/text-reverser" },
    { name: "Text to Binary Converter", path: "/tools/batch3/text-to-binary" },
    { name: "Binary to Text Converter", path: "/tools/batch3/binary-to-text" },
    { name: "Hex to Octal Converter", path: "/tools/batch3/hex-to-octal" },
    { name: "Octal to Hex Converter", path: "/tools/batch3/octal-to-hex" },
    { name: "Octal to Decimal Converter", path: "/tools/batch3/octal-to-decimal" },
    { name: "Decimal to Octal Converter", path: "/tools/batch3/decimal-to-octal" },
    { name: "Octal to Binary Converter", path: "/tools/batch3/octal-to-binary" },
    { name: "Binary to Octal Converter", path: "/tools/batch3/binary-to-octal" },
    { name: "Base32 Encoder", path: "/tools/batch3/base32-encoder" },
    { name: "Base32 Decoder", path: "/tools/batch3/base32-decoder" },
    { name: "SHA-256 Hash Generator", path: "/tools/batch3/sha256-hash-generator" },
    { name: "SHA-1 Hash Generator", path: "/tools/batch3/sha1-hash-generator" },
    { name: "MD5 Hash Generator", path: "/tools/batch3/md5-hash-generator" },
    { name: "UUID v4 Generator", path: "/tools/batch3/uuid-v4-generator" },
    { name: "Random String Generator", path: "/tools/batch3/random-string-generator" },
    { name: "Random Password Generator", path: "/tools/batch3/random-password-generator" },
];
