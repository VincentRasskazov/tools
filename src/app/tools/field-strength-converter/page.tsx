...
const units = [
  { name: "Tesla", value: 1 },
  { name: "Gauss", value: 0.0001 },
  { name: "Ampere/meter", value: 0.001257 },
];

export default function FieldStrengthConverter() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded shadow mt-8">
      <h1 className="text-2xl font-bold mb-4">Field Strength Converter</h1>
