...
const units = [
  ...
  { name: "Megabytes", value: 1048576 },
  { name: "Gigabytes", value: 1073741824 },
  { name: "Terabytes", value: 1099511627776 },
];
...
export default function DataSizeConverter() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded shadow mt-8">
      <h1 className="text-2xl font-bold mb-4">Data Size Converter</h1>
